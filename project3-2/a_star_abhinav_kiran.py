...
def initalize_varaibles():
    ...
    clearance = int(input("clearance (in mm):"))


# Rectangle 1
cv2.rectangle(canvas, (1500, y-2000), (1750, y-1000), (255, 0, 255), clearance)
cv2.rectangle(canvas, (1500, y-2000), (1750, y-1000), (0, 0, 255), -1)

# Rectangle 2
cv2.rectangle(canvas, (2500, y-1000), (2750, y-0), (255, 0, 255), clearance)
cv2.rectangle(canvas, (2500, y-1000), (2750, y-0), (0, 0, 255), -1)

# Circle shape
cv2.circle(canvas, (4200, y-1200), 600, (255, 0, 255), clearance)
